...
import TabDesign2 from "../../components/CustomeComponents/TabDesign2";
      ...
      return (
          <Row>
              ...
              <div className={'custom-header-nav'}>
                  <Tab.Container  defaultActiveKey={iconArray?.name?.toLowerCase()}>
